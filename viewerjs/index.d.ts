...
/**
 * Only available when Viewer has been activated once.
 */
declare class RuntimeViewer extends Viewer { 
  action: unknown;
  body: unknown;
  button: unknown;
  canvas: unknown;
  ...
  imageClicked: unknown;
  imageData: unknown;
  imageInitializing: unknown;
  imageRendering: unknown;
  images: unknown;
  index: unknown;
  initialBodyComputedPaddingRight: unknown;
  initialBodyPaddingRight: unknown;
